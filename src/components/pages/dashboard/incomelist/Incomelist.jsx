...
const Incomelist = () => {
    ...
    const handleincomelist = event => {
        ...
        if (user && user.email) {
            ...
            axios.post('https://moneybag-income-expense-tracker-server.onrender.com/income', incomeData)
                .then(res => {
    ...
    const handleDelete = id => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axios.delete(`https://moneybag-income-expense-tracker-server.onrender.com/income/${id}`)
                    .then(res => {
